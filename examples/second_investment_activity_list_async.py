"""Minimal async example: Second distribution investment activity list (standard)

Fetches the second distribution investment activity list (standard variant)
via the main distribution service.
...
async def main() -> None:
    ...
    async with AsyncKwaixiaodianClient(
        ...
        resp = await client.distribution.get_second_investment_activity_list_standard(
            access_token=access_token or ""
        )
        print(
            "Second investment activities (standard):",
